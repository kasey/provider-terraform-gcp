...
func main() {
	var (
		...
		// TODO: pluginDirectory should receive a default pointing to a canonical path in a container generated by the build process
		pluginDirectory = app.Flag("pluginDirectory", "Full path to directory where terraform plugin is located.").String()
	)
	...
	err := controller.StartTerraformManager(r, opts, ropts, log)
